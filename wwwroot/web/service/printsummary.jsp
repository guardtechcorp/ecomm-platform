...
<% {
   ...
   String sError = null;
   RequisitionInfo trInfo = web.getRequistionInfo(request);
   if (trInfo==null)
   {
       ...
       if (trInfo!=null)
       {
           ...
           if (urInfo!=null)
           {
               if (!web.hasAccessRole(AccessRole.ROLE_PORTAL_VIEW| AccessRole.ROLE_PORTAL_UPDATE))
               {
...
<div class="panel-heading" align="center"><font size="4"><b><%=bSummary?"Summary of Your Requisition Form":"LETTER OF MEDICAL NECESSITY"%></b></font></div>
