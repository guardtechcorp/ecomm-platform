...
<%
{
    ...
    if (nAccessLevel == Definition.ACCESSLEVEL_NEEDUSERLOGIN) {
        ...
        sbMessage.append("<UL><LI>If you are not a user, please <A class='focuslink' style='font-weight1:bold' href='" + mcBean.encodedUrl("index.jsp?action=Load_SignUp&rl=1&pt=Sign Up Informaton") + "'>Sign Up</A> now</LI><br>");
        ...
        sbMessage.append("<UL><LI>If you are not a user, please <A class='focuslink' style='font-weight1:bold' href='" + mcBean.encodedUrl("index.jsp?action=Load_SignUp&rl=1&pt=Sign Up Informaton&apply=1") + "'>Sign Up</A> ");
        ...
        if (!mcBean.isPendingMember(mbInfo.MemberID)) {
            ...
            sbMessage.append("<LI>You are not a member of this site. But you can <A class='focuslink' style='font-weight1:bold' href='" + mcBean.encodedUrl("index.jsp?action=Apply_SiteMember&rl=1&pt=Apply Membership of This Site&accessby="+Definition.ACCESSMODE_LOGINUSER) + "'>apply</A> ");
        ...
        sbMessage.append("<LI>You can <A class='focuslink' style='font-weight1:bold' href='" + mcBean.encodedUrl("index.jsp?action=Apply_SiteMember&rl=1&pt=Apply Membership of This Site") + "'>apply</A> ");
