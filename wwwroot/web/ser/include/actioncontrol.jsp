...
//BasicBean.dumpAllParameters(request);    
    if (sAction.equals("Switch_ToMytSite")||sAction.equals("Load_ShareFile"))
    {   //. Set Site Info
        mcBean.goToMemberSite(request, sAction);
    }

//System.out.println("Control Action1=" + sAction + "!");
    byte nAccessLevel = mcBean.getPageAccessLevel(request, sAction);
...
//System.out.println("sReturn=" + sReturn);                
      ...
      {//. It is timeout
         sAction = "Load_SignIn";
         bean.clearLastUrl();
//sLastUrl=/web/ser/index.jsp?action=Edit_WebPage&pageid=75&pagetitle=Web Page Information          
      }
    } else {
...
if (mcBean.getHttpsUrl()!=null)
{
 System.out.println(mcBean.getDomainName() + "-->" +mcBean.getDomainSidCGI());
    ...
    String sRedirectUrl = mcBean.getWebsiteUrl(request) + mcBean.encodedUrl("index.jsp?action="+sAction+"&pageid=" + mcBean.getPageID(request))+"&" + mcBean.getDomainSidCGI();
...
//            ret = mcBean.updateCompany(request);
        ...
        //<a href="/web/request.html?_url=%3D">Online Message</a>
