...
<TABLE width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:<%=mbInfo!=null?mbInfo.SloganBkColor:ownerInfo.SloganBkColor%>">
...
<% if (mbInfo==null) { %>
<TR>
 <TD colspan=2 align="center"><b>Everyone can join for free:</b></TD>
</TR>
<TR>
 <TD colspan=2 align="center">
 <script>createLeftButton();</script>
  <a class="button" href="<%=mcBean.encodedUrl("index.jsp?action=Load_SignUp&rootlink=yes&pagetitle=Sign Up Form")%>">&nbsp;&nbsp;Sign Up&nbsp;&nbsp;</a>
 <script>createRightButton();</script>
 </TD>
</TR>
<TR>
 <TD colspan=2 align="center" valign1="bottom">&nbsp;&nbsp;<b>User or Member: </b><A class='content' style='font-weight:bold'  href='<%=mcBean.encodedUrl("index.jsp?action=Load_SignIn&type=direct&pagetitle=User/Member Sigin-In")%>'>Sign In</A>
 </TD>
</TR>
<% } else { %>
<TR>
 ...
 <table cellspacing=0 cellpadding=0 width="100%" height="100%" align="center" border=0 bgColor="<%=mbInfo.SloganBkColor%>">
  ...
  <td>
   <table width="100%">
    <tr>
    <td valign="top" style="border-bottom: 1px solid #DFDFDF;">&nbsp;<font color="#FFEFD5"><b>Hi, <%=mbInfo.getPersonalName()%></b></font>
