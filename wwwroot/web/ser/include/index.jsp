...
<%
   MemberAccountBean.setSiteConfig(sn, cfInfo);
   String sOnLoad = "";
...
<BODY TOPMARGIN=0 <%=sOnLoad%> onUnload="onBrowserClose('<%=mcBean.encodedUrl("index.jsp?action=Sign Out_SignIn&type=windowclose")%>', true);">
