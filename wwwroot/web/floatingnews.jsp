...
%>
<% if (cfInfo.NewsArea==2&&web.getRealAction(request)==null) { %>
 ...
 <table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
   <td id="dragbar" style="cursor:hand; cursor:pointer" width="100%" height="22" onMousedown="initializedrag(event);" align="center">
    ...
    onMouseout="dragswitch=0"><font face="Verdana" color="#FFFFFF" size="3"><strong><%=Utilities.getValue(cfInfo.NewsTitle)%></strong></font></layer></ilayer>
   </td>
