...
//System.out.println("cgInfo = "+ cgInfo);
  ...
  sAction = "Send Now";
%>
<a href="feedbacklist.jsp?action=list">Customer Feedback List</a> >
<b>View and Response Customer Feedback</b>
<p>The form below will allow you to view and response customer feedback.</p>
<form name="feedback" action="feedback.jsp" method="post" onsubmit="return validateFeedback(this);">
  ...
  <table width="95%" cellpadding="4" cellspacing="1" border="0" align="center">
    <tr>
...
<% } %>
    <tr>
      <td class="row1" width="18%" height="12" align="right" valign="top">Feedback Content: </td>
