...
<%
  ProductBean bean = new ProductBean(session, 18);
...
%>
<form name="productselect" action="productselect.jsp" method="post">
...
<table width="100%" cellpadding="1" cellspacing="1" border="0" class="forumline" align="center">
 <tr>
  ...
  <th width="74%" align="center" class="thCornerL">Prouct Name</th>
 </tr>
    ...
    <tr>
      <td colspan="3" class="catBottom">
        <table width="100%" border="0">
          ...
          <tr>
            <td width="75%" height="2" align="left"><b><font color="#DD6900"><%=sCategoryName%></font></b></td>
            <td width="25%" height="2"><input type="submit" name="action" value="Apply"/></td>
          </tr>
        </table>
      </td>
    </tr>
