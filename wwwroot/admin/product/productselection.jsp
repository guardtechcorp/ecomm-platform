...
%>
<form name="productselect" action="productselection.jsp" method="post">
...
<table width="100%" cellpadding="1" cellspacing="1" border="0" class="forumline" align="center">
 <tr>
  ...
  <th width="74%" align="center" class="thCornerL">Proucts in this category</th>
 </tr>
...
<%} else {
  ...
  for (int i=0; i<ltArray.size(); i++) {
     ...
     if (bean.isSelected(info.ProductID)) {
%>
    <tr class="normal_row">
