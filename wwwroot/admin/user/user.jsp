...
<% } %>
    ...
    <!--tr>
      ...
      <td class="row1" width="30%"><input type="text" name="email" size="36" maxlength="50" value="<%=Utilities.getValue(urInfo.EMail)%>" disabled></td>
...
<% if (urInfo.UserID<=0) {%>
    <tr>
      <td class="row1" width="15%" align="right"> </td>
      <td class="row1" width="30%"><input type="checkbox" value="1" name="emailbox" checked> Create an E-Mail box also</td>
      <td class="row1" colspan="2"> (E-Mail address: <b>Username@<%=bean.getEmailDomain()%></b>)</td>
    </tr>
<% } else { %>
    <tr>
      <td class="row1" width="15%" align="right"> E-Mail:</td>
      <td class="row1" colspan="3" height="25"><b><%=bean.getEmail(urInfo)%></b></td>
    </tr>
<% } %>
<% if (bean.hasGrantRight()) {%>
    ...
    <tr>
      <td colspan="4" height="25" align="center">
        <table cellpadding="2" cellspacing="1" border=0 width="100%" class="forumline" align="center">
          <tr bgcolor="#9AAEDA">
...
%>
          <tr>
            ...
            <td class="row1" width="60%">If check it, this email will automatically forward to the email box of this user.</td>
          </tr>
<% } %>
        </table>
      </td>
