...
//bean.showAllParameters(request, out);
  ...
  String sHelpTag = "orderexport";
/*
  String sTitleLinks = "";
  if (sReturn!=null)
    sTitleLinks = "<a href=\"" + sReturn +"\">" + sDisplay + "</a> > ";
  sTitleLinks += "<b>Export the Orders</b>";
*/
  String sTitleLinks = bean.getNavigation(request, "Export the Orders");
%>
<%@ include file="../share/uparea.jsp"%>
<SCRIPT Language="JavaScript" src="/staticfile/admin/scripts/export.js"></SCRIPT>
<SCRIPT Language="JavaScript">setUpArea('<%=sHelpTag%>', '<%=sTitleLinks%>');</SCRIPT>
The form below will allow you to select format and range to export orders information.
<form name="orderexport" action="orderexport.jsp" method="post" onSubmit="return validateExport(this, '<%=Utilities.getInt(bean.getCacheData(bean.KEY_TOTALROWS), 0)%>');">
<table width="90%" cellpadding="1" cellspacing="0" border="0" class="forumline" align="center">
    <tr>
      <th colspan="2" class="thHead">Export Order Records</th>
    </tr>
...
<SCRIPT>onExportLoad(document.orderexport);</SCRIPT>
