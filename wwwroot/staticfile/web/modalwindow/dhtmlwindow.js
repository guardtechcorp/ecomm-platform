...
imagefiles:['/staticfile/web/modalwindow/min.gif', '/staticfile/web/modalwindow/close.gif', '/staticfile/web/modalwindow/restore.gif', '/staticfile/web/modalwindow/resize.gif'], //Path to 4 images used by script, in that order
...
load:function(t, contenttype, contentsource, title){ //loads content into window plus set its title (3 content types: "inline", "iframe", or "ajax")
	...
	if (contenttype=="inline")
		...
		if (!t.contentarea.firstChild || t.contentarea.firstChild.tagName!="IFRAME") //If iframe tag doesn't exist already, create it first
			t.contentarea.innerHTML='<iframe src="/staticfile/web/blank.html" style="margin:0; padding:0; width:100%; height: 100%" name="_iframe-'+t.id+'"></iframe>'
...
document.write('<div id="dhtmlwindowholder"><span style="display:inline"></span></div>') //container that holds all dhtml window divs on page
