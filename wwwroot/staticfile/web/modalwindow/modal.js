...
var dhtmlmodal={
veilstack: 0,
open:function(t, contenttype, contentsource, title, attr, recalonload, clickclose){
    ...
    if (typeof clickclose!="undefined" && clickclose==false)
       t.controls.firstChild.nextSibling.style.display="none"; //childNodes(0).nextSibling
