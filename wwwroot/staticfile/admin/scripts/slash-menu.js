...
if (typeof menu!="undefined"){
	for(i=0; i<Math.max(titles.length, submenus.length); i++){
		...
		arrows[i].src = "css/media/slash-expanded.gif";
...
if (typeof menu!="undefined"){
	for(i=0; i<Math.max(titles.length, submenus.length); i++){
		...
		arrows[i].src = "css/media/slash-/collapsed.gif";
...
function restore() {
    if(getcookie("menu") != null) {
        ...
        for(var i in hidden) {
            ...
            arrows[hidden[i]].src = "css/media/slash-collapsed.gif";
        }
    }
}
...
function hidemenu(sm) {
    ...
    if(parseInt(submenus[sm].style.height) <= nr) {
        ...
        arrows[sm].src = "css/media/slash-collapsed.gif";
...
function showmenu(sm) {
    ...
    if(parseInt(submenus[sm].style.height) > (parseInt(heights[sm])-nr)) {
        ...
        arrows[sm].src = "css/media/slash-expanded.gif";
    }
